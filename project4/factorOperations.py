...
def joinFactors(factors: List[Factor]):
    ...
    new_factor = Factor(list(unconditioned_vars), list(conditioned_vars), list(factors)[0].variableDomainsDict())
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        unconditioned_vars = factor.unconditionedVariables() - {eliminationVariable}
        conditioned_vars = factor.conditionedVariables()

        eliminated_factor = Factor(list(unconditioned_vars), list(conditioned_vars), factor.variableDomainsDict())
